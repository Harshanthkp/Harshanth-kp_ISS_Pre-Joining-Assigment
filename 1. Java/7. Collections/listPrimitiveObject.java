// This program demonstrates about the primitive object to access the List.
...
public class list_primitive_object {
public void listOperations() {
	...
	public void setOperations() {
		...
		setA.addAll(Arrays.asList(new Integer[] { 10, 16, 9, 18, 4, 13, 2, 0}));

        Set<Integer> setB = new HashSet<Integer>();
        setB.addAll(Arrays.asList(new Integer[] { 11,13, 17, 5, 4, 0, 17, 15, 10, 11 }));
	...
	public static void main(String[] args) {
		...
		list_primitive_object collectionDemo = new list_primitive_object();
